        ...
        shareContent: {
            ...
            interactionGuide: (() => {
                const guideLookup: Record<string, string[]> = {
                    'ENFP': ['别用死板规矩管我，我会失去生活热情', '重视我的奇思妙想，敷衍比拒绝更伤人', '允许我不断改变，自由是我生命力的源泉'],
                    'ENTP': ['讨论时对事不对人，别把辩论当成攻击', '别急着否定我的观点，否则我会拒绝沟通', '给足逻辑推导时间，催促只会让我更混乱'],
                    'ESFP': ['别把气氛搞太严肃，太压抑我会想逃跑', '少点人生大道理，多陪我实实在在生活', '参与我的世界，否则我会慢慢从你那抽离'],
                    'ESTP': ['说话直奔主题，拐弯抹角会让我极度不耐烦', '别拖拉，事办不成我会直接接管控制权', '绝对信任我的能力，怀疑我会导致直接翻脸'],
                    'INFJ': ['别强行窥探我内心，我会受惊立刻关门', '必须尊重我的信念，否则我会彻底疏远你', '允许我安静独处，那是我在进行自我修复'],
                    'INFP': ['别踩我的价值观底线，那是我最后的坚持', '拒绝任何形式的冷暴力，那会让我心死', '给予安全感，否则你永远听不到我的真话'],
                    'ISFP': ['别试图控制我的生活，控制只会换来沉默', '别忽视我的感受，我不会吵闹但会走远', '拒绝拿我跟别人比较，这是伤我最快的方式'],
                    'ISTP': ['拒绝情绪轰炸，否则我会自动切断联系', '有事请直说，我没有兴趣去猜你的心思', '别粘得太紧，过近的距离感会让我后退'],
                    'ENFJ': ['别把我的付出当义务，反馈对我很重要', '拒绝无底线的索取，我的热情也会耗尽', '别只依赖我，我也需要被你细心照顾'],
                    'ENTJ': ['必须遵守承诺，失信一次信用分直接归零', '拒绝情绪化沟通，别用眼泪来处理问题', '别三天两头改主意，我会立刻停止合作'],
                    'ESFJ': ['别把我的体贴当理所应当，我也想被宠爱', '拒绝冷处理，冷战是对我最深层的伤害', '记得表达感谢，否则我会收回所有热情'],
                    'ESTJ': ['尊重规则与流程，敷衍就是对我的不尊重', '拒绝拖延时间，浪费时间等于浪费我生命', '保持环境井然有序，混乱感会让我暴躁'],
                    'INTJ': ['别打断我的思路，打断思考比吵架还烦', '专业领域不容质疑，否则直接把你拉黑', '拒绝情绪失控的人，这会降低你的信用分'],
                    'INTP': ['别催我做决定，逼迫只会让进度更拖延', '必须给足思考空间，没空间我就开始摆烂', '别强迫我社交，假装正常比工作还要累'],
                    'ISFJ': ['请看见我的细小付出，忽视会让我心寒', '别以为我不说就是没情绪，其实我在忍', '回应请稳定可靠，忽冷忽热会击垮我'],
                    'ISTJ': ['必须守时，迟到是对我时间的最不尊重', '别随意改动计划，这会让我极度焦虑', '沟通必须清晰明确，含糊不清最浪费时间'],
                };
